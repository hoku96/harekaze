function NorenPanel({
  ...
  return (
    <div
      className="relative flex flex-col items-center pt-10 overflow-hidden rounded-b-[4px] w-[118px] max-[820px]:w-[86px]"
      style={{
    ...
    >
      {/* Top cap bar */}
      <div
        className="absolute top-0 left-0 right-0 h-3 bg-amber-deep"
        aria-hidden="true"
      />
...
export function Noren() {
  return (
    ...
    >
      ...
      <NorenPanel char="晴" />
      <NorenPanel char="れ" />
      <NorenPanel char="風" caption="ご飯処" hasSeal />
    </div>
  )
}
